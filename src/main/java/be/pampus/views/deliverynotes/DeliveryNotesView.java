package be.pampus.views.deliverynotes;
...
@Route(value = "delivery-notes", layout = MainLayout.class)
@RolesAllowed("USER")
public class DeliveryNotesView extends Div {
    ...
    public DeliveryNotesView() {
        addClassName("delivery-notes-view");
        setSizeFull();
        createGrid();
        add(grid);
    }
